...
public class OxygenLeadTest {
  ...
  public void testConstructor() {
    ...
    OxygenLead actualOxygenLead =
        new OxygenLead(
            "Oxy Prop Name",
            "Oxy Prop Contact Primary",
            "Oxy Prop Contact Secondary",
            locationLat,
            locationLon,
            locationAcu,
            locationTimestamp,
  ...
  public void testUpdateLocation2() {
    ...
    BigDecimal locationLon = BigDecimal.valueOf(42L);
    BigDecimal locationAcu = BigDecimal.valueOf(42L);
    oxygenLead.updateLocation(
        locationLat, locationLon, locationAcu, new Date(1L), "https://example.org/example");
    assertEquals(
        "OxygenLead(oxyLeadId=0, oxyPropName=, oxyPropContactPrimary=, oxyPropContactSecondary=, locationLat=42,"
