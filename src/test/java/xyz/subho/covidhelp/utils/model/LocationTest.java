...
public class LocationTest {
    ...
    public void testConstructor() {
        ...
        assertEquals("Location(latitude=0.0, longitude=0.0, accuracy=0.0, timestamp=Thu Jan 01 05:30:00 IST 1970)",
    ...
    public void testConstructor3() {
        ...
        oxygenLead.setLastVerifiedAt(Date.from(atStartOfDayResult.atZone(ZoneId.systemDefault()).toInstant()));
    ...
    public void testCovertUserLocationFromDB2() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> (new Location()).covertUserLocationFromDB(","));
    }

    @Test
    public void testCovertUserLocationFromDB3() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> (new Location()).covertUserLocationFromDB("42"));
    }
